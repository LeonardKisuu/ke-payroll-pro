...
export default async function MyPayslipsPage() {
  ...
  const payslips = records.map((r) => ({
    ...
    commuterAllowance: r.record.commuterAllowance || 0,
    carAllowance: r.record.carAllowance || 0,
    otherAllowances: r.record.otherAllowances || 0,
    bonusPay: r.record.bonusPay || 0,
    leavePay: r.record.leavePay || 0,
    leaveDeduction: r.record.leaveDeduction || 0,
    arrears: r.record.arrears || 0,
